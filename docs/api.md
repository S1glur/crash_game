...
| seed | Тема | Ставка | Ожидаемый исход | Для чего |
|---|---|---|---|---|
| 1 | green | no-boost | ранний крах (до 1-го уровня) | сценарий 3, «Забрать» недоступна |
| 2 | green | boost-x2 | крах после срабатывания бустера | сценарий 4 |
| 3 | red | boost-x3 | высокий крах (≥ 5.0) | сценарий 2, долгий полёт |
| 42 | green | boost-x2 | средний крах ~2.5 | базовая демонстрация |

Значения в колонке «ожидаемый исход» проставляются после первого прогона — они
детерминированы, поэтому один раз посмотрели и зафиксировали.
